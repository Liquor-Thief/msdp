...
def cpo_step(pop, fitness, best_sol, best_fit, lb, ub, iteration, max_iter,fobj):
    ...
    for i in range(pop_size):
        ...
        if r < 0.25:
            ...
            r1, r2 = np.random.randint(pop_size, size=2)
...
def rime_cpo_opt(pop_size, max_iter, dim, lb, ub,fobj):
    ...
    for iteration in range(1, max_iter+1):
        ...
        pop, fitness, best_sol, best_fit = cpo_step(
            pop, fitness, best_sol, best_fit, lb, ub,
            iteration, max_iter,fobj
        )
